...
<script>
		if(typeof(EventSource)!==undefined)
		{
			...
			source.onmessage = function(event)
			{
				...
				var html = "<table class='table'><th>Sr. No</th><th>Car Number</th><th>Brand</th><th>Car Type</th><th>Car Image</th><th>MFG date</th><th>Longitude</th><th>Latitude</th>";
				var cnt = 0;
				for(var i=0; i<JSONObject.length; i++)
				{
					...
					html +='<td>'+JSONObject[i].lng+'</td></tr>';
